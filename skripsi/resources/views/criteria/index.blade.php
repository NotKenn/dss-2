            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{route('criteria.create')}}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New Criteria</a>
                    </div>
                            ...
                            @forelse ($criteria as $cat)
                                <tr>
                                        ...
                                        <td class="text-center ">
                                            <a  href="{{route('criteria.edit', $cat->id)}}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                            ...
                                            <span>
                                            <a href="{{route('criteria.destroy', $cat->id)}}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Remove">
