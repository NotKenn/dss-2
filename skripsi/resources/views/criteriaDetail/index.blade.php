            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{route('criteriadetail.create')}}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New Criteria</a>
                    </div>
                            ...
                            @forelse ($criteriad as $catd)
                                <tr>
                                        ...
                                        <td class="text-center ">
                                            <a  href="{{route('criteriadetail.edit', $catd->id)}}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                            ...
                                            <span>
                                            <a href="{{route('criteriadetail.destroy', $catd->id)}}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Remove">
